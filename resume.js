...
function createSummarySection(summary) {
    let summaryString = `
    <div class="row">  
        <h3 class="col xs clickable"><button class = "btn btn-info" title = "Click to learn more about Ammon Roberts">SUMMARY</button></h3>
    ...
    <div id = "summarySectionToggle">
        <div class="row">
            ...
            <div class="col xs card bg-light p-3">
            ${resume.summary}
            </div>
        </div>
    </div>`;
...
function createExperienceSection(experience) {
    ...
    <div>
        <div class="row">
            <h3 class ="col xs clickable" title = "Click to show relevant work experience"><button class = "btn btn-info">EXPERIENCE</button></h3>
            <div class="grayblock"></div>
        </div>
...
function createSkillsSection(skills) {
    ...
    <div>
        <div class="row">
            <h3 class ="col xs clickable"><button class = "btn btn-info" title = "Click to show relevant skills">SKILLS</button></h3>
            <div class="grayblock"></div>
        </div>
